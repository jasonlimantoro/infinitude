<div class="modal" id="modalSehat">
    ...
    <div class="modal-content">
        ...
        <div class="modalSlide">
            ...
            <img src="/images/galleries/Sehat Cerdas_1.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">2 / 6</div>
            <img src="/images/galleries/Sehat Cerdas_2.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">3 / 6</div>
            <img src="/images/galleries/Sehat Cerdas_3.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">4 / 6</div>
            <img src="/images/galleries/Sehat Cerdas_4.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">5 / 6</div>
            <img src="/images/galleries/Sehat Cerdas_5.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">6 / 6</div>
            <img src="/images/galleries/Sehat Cerdas_6.jpg">
        </div>
...
<div class="modal" id="modalGeneral">
    ...
    <div class="modal-content">
        ...
        <div class="modalSlide">
            <div class="numbertext">1 / 6</div>
            <img src="/images/galleries/General Meeting_1.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">2 / 6</div>
            <img src="/images/galleries/General Meeting_2.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">3 / 6</div>
            <img src="/images/galleries/General Meeting_3.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">4 / 6</div>
            <img src="/images/galleries/General Meeting_4.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">5 / 6</div>
            <img src="/images/galleries/General Meeting_5.jpg">
        </div>

        <div class="modalSlide">
            <div class="numbertext">6 / 6</div>
            <img src="/images/galleries/General Meeting_6.jpg">
        </div>
...
<div class="modal" id="modalWonderWoman">
    ...
    <div class="modal-content">
        ...
        <div class="modalSlide">
            <div class="numbertext">1 / 6</div>
            <img src="/images/galleries/Wonder Woman_1.png">
        </div>

        <div class="modalSlide">
            <div class="numbertext">2 / 6</div>
            <img src="/images/galleries/Wonder Woman_2.png">
        </div>

        <div class="modalSlide">
            <div class="numbertext">3 / 6</div>
            <img src="/images/galleries/Wonder Woman_3.png">
        </div>

        <div class="modalSlide">
            <div class="numbertext">4 / 6</div>
            <img src="/images/galleries/Wonder Woman_4.png">
        </div>

        <div class="modalSlide">
            <div class="numbertext">5 / 6</div>
            <img src="/images/galleries/Wonder Woman_5.png">
        </div>

        <div class="modalSlide">
            <div class="numbertext">6 / 6</div>
            <img src="/images/galleries/Wonder Woman_6.png">
        </div>
