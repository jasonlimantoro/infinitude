...
var container = ['.section1 .container-main-background', '.section3 .container-history', '.section4 .container-organization'];
...
// The date array
var month_array = ['SEP', 'JAN', 'APR', 'MAY', 'AUG', 'DEC'];
var year_array = [' 2016', ' 2017', ' 2017', ' 2017', ' 2017', ' 2017'];
...
function createDate(bottom, left, node, spanElement, index) {
    var headingDate = document.createElement('h3');
...
!function (i) {
  "use strict";
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (i),
